...
ALTER TABLE Transmission ADD CONSTRAINT carTransmission_PK PRIMARY KEY ( TransmissionID ) ;
...
CREATE INDEX customer__IDX ON customer
  ( address_AddressID ASC
  ) ;
CREATE INDEX customer__IDXv1 ON customer
...
CREATE INDEX vehicle__IDX ON vehicle
  ( carColor_ColorID ASC
  ) ;
CREATE INDEX vehicle__IDXv1 ON vehicle
  (
    carTransmission_TransmissionID ASC
  ) ;
CREATE INDEX vehicle__IDXv2 ON vehicle
  ( carBody_VehicleBodyID ASC
  ) ;
CREATE INDEX vehicle__IDXv3 ON vehicle
  ( DriveTrain_DrivetrainID ASC
  ) ;
CREATE INDEX vehicle__IDXv4 ON vehicle
  ( Motor_MotorID ASC
  ) ;
CREATE INDEX vehicle__IDXv5 ON vehicle
  ( carFeatures_FeatureID ASC
  ) ;
CREATE INDEX vehicle__IDXv6 ON vehicle
  ( carModel_ModelID ASC
  ) ;
...
ALTER TABLE vehicle ADD CONSTRAINT vehicle_carTransmission_FK FOREIGN KEY ( carTransmission_TransmissionID ) REFERENCES Transmission ( TransmissionID ) ;
